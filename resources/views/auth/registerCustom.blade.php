...
<head>
  <meta charset="utf-8">
   ...
   <!-- Bootstrap 4.0-->
    <link rel="stylesheet" href="{{ asset('bower_components/bower/Auth/css/bootstrap.min.css') }}">
    
    <!-- Bootstrap extend-->
    <link rel="stylesheet" href="{{ asset('bower_components/bower/Auth/css/bootstrap-extend.css') }}">
    
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('bower_components/bower/Auth/css/master_style.css') }}">

    <!-- Superieur Admin skins -->
    <link rel="stylesheet" href="{{ asset('bower_components/bower/Auth/css/_all-skins.css') }}">
    {{-- link font-awsome --}}
    <link rel="stylesheet" href="{{ asset('bower_components/bower/Auth/css/font-awesome/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('bower_components/bower/Auth/css/toastr.min.css') }}">
     @routes()
</head>
...
<body class="hold-transition bg-img" style="background-image: url(../../images/gallery/full/6.jpg)" data-overlay="4">
    ...
    <div class="container h-p100">
        ...
        <!-- jQuery 3 -->
    <script src="{{ asset('bower_components/bower/Auth/js/jquery-3.3.1.js') }}"></script>
    <!-- popper -->
    <script src="{{ asset('bower_components/bower/Auth/js/popper.min.js') }}"></script>
    <!-- Bootstrap 4.0-->
    <script src="{{ asset('bower_components/bower/Auth/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('bower_components/bower/Auth/js/toastr.min.js') }}"></script>
    <!-- {{-- custom js --}} -->
