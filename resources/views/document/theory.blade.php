...
<div id="edit" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">{{ trans('message.edit') }} {{ trans('message.theory') }}</h4>
            </div>
            <div class="modal-body">
                <form action="" method="POST" role="form" novalidate data-url="{{ asset('documents/addTheory') }}">
                    @csrf
                    <legend>{{ trans('message.edit') }} {{ trans('message.theory') }} </legend>
                    <div class="form-group">
                        <label for="">{{ trans('message.course') }}</label>
